...
public class ExtraTrailersRecycleAdapter extends RecyclerView.Adapter<MovieTrailersViewHolder>
{
    private Activity activity;
    private List<Trailer> trailerList;

    public ExtraTrailersRecycleAdapter(Activity activity, List<Trailer> trailerList) {
